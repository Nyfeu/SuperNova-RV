...
## 3. Condições Suportadas (Baseado em Funct3)
...
### 3.1. Detalhes das Operações de Comparação
...
### 4.2. Habilitação por `is_branch_i`
...
## 5. Exemplos de Instruções

### 5.1. Formato das Instruções de Desvio (B-Type)
```
